...
namespace AncientEgyptianMathematics.Editor
{
    ...
    public static class AndroidDeployMenu
    {
        ...
        const string PackageId = "com.densappstudio.ancient.egyptian.mathematics";

        [MenuItem("AncientEgyptianMathematics/Android/Install APK via ADB (USB)", false, MenuPriority)]
        public static void InstallApkViaAdb()
        {
            ...
            if (!File.Exists(apk))
            {
                EditorUtility.DisplayDialog(
                    "Install APK via ADB",
                    $"APK not found:\n{apk}\n\nBuild first (AncientEgyptianMathematics → Build Release APK) or use Build and Install.",
                    "OK");
                return;
            }
        ...
        [MenuItem("AncientEgyptianMathematics/Android/Build and Install APK via ADB (USB)", false, MenuPriority + 1)]
        ...
        [MenuItem("AncientEgyptianMathematics/Android/Deploy APK via Bluetooth", false, MenuPriority + 10)]
        ...
        [MenuItem("AncientEgyptianMathematics/Android/Build and Deploy APK via Bluetooth", false, MenuPriority + 11)]
