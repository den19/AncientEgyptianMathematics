# Release build: com.densappstudio.ancientegyptianmathematics.apk in the project root.
...
$method = "AncientEgyptianMathematics.Editor.AndroidApkBuilder.BuildFromBatch"
